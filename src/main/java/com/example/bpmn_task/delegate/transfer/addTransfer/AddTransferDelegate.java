package com.example.bpmn_task.delegate.transfer.addTransfer;
...
@Component("addTransferDelegate")
public class AddTransferDelegate implements JavaDelegate {
    private final TransferService transferService;

    @Autowired
    public AddTransferDelegate(TransferService transferService) {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        TransferResponse transferResponse = transferService.addTransfer(transferRequest);
